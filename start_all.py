...
Starts all services: GigaPath API, Main ML API, Backend, Frontend
"""
...
def main():
    ...
    services = [
        {
            "name": "GigaPath API (Port 5002)",
            "command": "python api/gigapath_api.py --port 5002" if sys.platform != "win32" else "python api\\gigapath_api.py --port 5002",
    ...
    print("   GigaPath API: http://localhost:5002")
